...
CATEGORIES = {
    ...
    "מוצרי חלב": ["מעדנ" ,"מעדן" ,"חלב", "גבינה", "יוגורט", "שמנת", "קוטג", "גבינת", "מוצרלה"],
    "לחמים": ["לחם", "פיתות", "לחמניות", "טורטיות"],
    "בשר ודגים": ["סלומון", "בשר", "עוף", "דג נסיכה", "מושט", "המבורגר"],
    "קפואים": ["קפוא"],
    "ירקות": ["עגבנייה", "עגבניה", "מלפפון", "גזר", "פלפל", "בצל", "פטריות",
              "חסה", "שום קלוף", "כוסברה", "כרוב", "שומר", 'תפו"א', "קולורבי"],
    ...
    "מוצרי מזון יבשים": ["שוקולד מריר","שוקולד חלב","שומשום" ,"פסטה", "אורז", "שמן", "קמח", "סוכר", "מלח", "קרקר", "פתיתים", "שוקולית", "מיונז", "שקיות קוקי"],
